#!/bin/bash
#SBATCH -J md_holdout_all
#SBATCH -N 1
#SBATCH --ntasks-per-node 1
#SBATCH -t 02:00:00
#SBATCH -p skx-dev
#SBATCH -A TG-CHM250118
#SBATCH -o md_holdout_all_%j.out
#SBATCH -e md_holdout_all_%j.err
...
# Cache full-model reference forces, then evaluate all pruned models (skips existing *.npy).
